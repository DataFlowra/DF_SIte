    ...
    <div className="flex flex-col h-full justify-between relative z-10">
      <div className="flex justify-between items-start">
        ...
        <div className="text-right">
          <div className="text-[10px] font-black text-data-slate uppercase tracking-widest mb-1">Active License</div>
      ...
      <div className="mt-8 space-y-4">
        <div className="flex justify-between items-center mb-2">
          <span className="text-[10px] font-black text-data-slate uppercase tracking-widest">Resource Allocation</span>
